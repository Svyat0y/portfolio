export const aboutContent = {
  paragraphs: [
    'Software Engineer with 2.5+ years of experience building modern web applications with React and TypeScript, with hands-on experience in back-end development — from UI components to backend APIs built with Node.js and CMS integrations.',
